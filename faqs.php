...
<head>
	...
	<title>FAQs | IEEE SYW CONGRESS 2019</title>
...
<body>
	<div id="fb-root"></div>
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.3&appId=2241156915925945&autoLogAppEvents=1"></script>
	<!-- Preloader -->
	<script>
	...
	<?php require_once 'process/common/headers/faqs_navbar.php'?>
	<!-- NAVBAR SECTION ENDS -->

	<div id="page-banner-area" class="page-banner-area" style="background-image:url(images/banners/faq.jpg)">
		<!-- Subpage title start -->
	...
	<?php require_once 'process/common/sections/faqs-content.php'?>
	<!-- FOOTER SECTION ENDS -->
