...
<div id="index_slider" class="carousel slide carousel-fade" data-ride="carousel">
  <ol class="carousel-indicators">
    ...
    <li data-target="#index_slider" data-slide-to="1"></li>
    <li data-target="#index_slider" data-slide-to="2"></li>
  </ol>
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      ...
      <div class="slider-content">
          <div class="col-md-12">
              <h2 class="slide-title1 animated5">IEEE INNOVATION NATION SRI LANKA</h2>
              <div class="header-title-divider animated5"></div>
