<section id="index_intro_section">
	<div class="container">
					...
					<div class="tab-content" id="pills-tabContent">
					  	...
					  	<div class="tab-pane fade animated fadeIn" id="pills-networking" role="tabpanel" aria-labelledby="pills-networking-tab">
                            ...
                            <ul class="list-arrow">
                                ...
                                <li><i class="fas fa-chevron-right"></i> Can colloborate with Industrial Community </li>
                                <li><i class="fas fa-chevron-right"></i> Connect with IEEE Executives</li>
                                <li><i class="fas fa-chevron-right"></i> Also can meet the IEEE SLSYWC Team</li>
                            </ul>
					  	</div>
					  	<div class="tab-pane fade animated fadeIn" id="pills-fun" role="tabpanel" aria-labelledby="pills-fun-tab">
                            ...
                            <ul class="list-arrow">
                                ...
                                <li><i class="fas fa-chevron-right"></i> "IEEE Hendawa", the Colors Night</li>
                                <li><i class="fas fa-chevron-right"></i> Ice-Breaks+</li>
                            </ul>
					  	</div>
					</div>
				</div>
